...
function renderHostPilotageTab(gs, phase) {
  ...
  out += `<div class="host-section host-section-nav">
    ...
    <div class="host-ctrl-row" style="margin-top:6px;">
      ...
      ` : ''}
      ${phase === 'round_end' ? `
        <button class="hbtn hbtn-success hbtn-pulse" style="padding:12px 32px;min-width:200px;" onclick="hostAction('next_round')">▶▶ Manche suivante</button>
    ...
    if (!bz?.firstPseudo && isLocked) {
      ...
      out += `
        <div style="text-align:center;padding:16px 8px;">
          ...
          <button class="hbtn hbtn-success hbtn-pulse" style="font-size:1.1rem;padding:14px 36px;min-width:240px;" onclick="hostAction('activate_buzzer')">🔔 ACTIVER LES BUZZERS</button>
        </div>`;
      ...
      out += `
        <div class="buzzer-host-card ${blr?.result === 'correct' ? 'buzzer-host-correct' : blr?.result === 'wrong' ? 'buzzer-host-wrong' : ''}">
          ...
          <div class="host-ctrl-row" style="margin-top:10px;">
            <button class="hbtn hbtn-primary hbtn-pulse" style="font-size:1.05rem;padding:14px 32px;min-width:220px;" onclick="hostAction('next_question')">⏭ Question suivante</button>
          </div>
          ...
          <div class="host-ctrl-row">
            <button class="hbtn hbtn-success hbtn-pulse" style="padding:13px 28px;font-size:.95rem;min-width:160px;" onclick="hostAction('award_buzzer_correct')">✅ Bonne (+1)</button>
            <button class="hbtn hbtn-danger" style="padding:13px 28px;font-size:.95rem;min-width:160px;" onclick="hostAction('buzzer_mark_wrong')">❌ Mauvaise</button>
          </div>
          <div class="host-ctrl-row" style="margin-top:8px;">
            <button class="hbtn hbtn-secondary" style="font-size:.85rem;min-width:200px;" onclick="hostAction('reveal_answer')">📋 Afficher la réponse</button>
          </div>
      ...
      out += `
        <div style="text-align:center;padding:10px;">
          ...
          <button class="hbtn hbtn-primary hbtn-pulse" style="margin-top:12px;padding:12px 32px;min-width:200px;" onclick="hostAction('reveal_answer')">📋 Afficher la réponse</button>
        </div>`;
    }
    out += `</div>`;
  }
    ...
    if (answerMode === 'vote_input') {
      ...
      out += `
        <div style="text-align:center;padding:12px 8px;">
          ...
          <div class="host-ctrl-row">
            <button class="hbtn hbtn-primary hbtn-pulse" style="padding:12px 32px;min-width:200px;" onclick="hostAction('vote_start_voting')">🗳️ Lancer les votes</button>
          </div>
        </div>`;
