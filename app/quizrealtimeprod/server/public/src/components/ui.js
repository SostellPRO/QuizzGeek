...
const GAME_ICON_PATHS = {
  ...
  // Palette unifiée : indigo-950 #1e1b4b · indigo-800 #3730a3 · violet-600 #7c3aed
  //                   indigo-300 #a5b4fc · bleu-400 #60a5fa · blanc #fff

  // ── Rôle : Jouer (smartphone + badge violet)
  profile:
    '<rect x="21" y="7" width="22" height="40" rx="5" fill="#1e1b4b"/>' +
    '<rect x="24" y="11" width="16" height="26" rx="3" fill="#3730a3"/>' +
    '<rect x="28" y="40.5" width="8" height="2.5" rx="1.2" fill="#312e81"/>' +
    '<path d="M28 18v14l12-7Z" fill="#fff"/>' +
    '<circle cx="46" cy="13" r="7" fill="#7c3aed"/>' +
    '<path d="M43 13l2.5 2.5 4.5-5" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>',

  // ── Rôle : Animateur (micro violet)
  host:
    '<rect x="25" y="7" width="14" height="24" rx="7" fill="#3730a3"/>' +
    '<rect x="28" y="10" width="8" height="18" rx="4" fill="#7c3aed"/>' +
    '<rect x="28" y="14" width="8" height="1.5" rx=".7" fill="#a5b4fc" opacity=".6"/>' +
    '<rect x="28" y="18" width="8" height="1.5" rx=".7" fill="#a5b4fc" opacity=".6"/>' +
    '<rect x="28" y="22" width="8" height="1.5" rx=".7" fill="#a5b4fc" opacity=".6"/>' +
    '<path d="M17 28c0 9.5 6.7 15.5 15 16.5v5h-5v3h10v-3h-5v-5C39.3 43.5 47 37.5 47 28" fill="none" stroke="#a5b4fc" stroke-width="2" stroke-linecap="round"/>' +
    '<path d="M22 53h20" stroke="#3730a3" stroke-width="2.5" stroke-linecap="round"/>',

  // ── Rôle : Écran TV (moniteur bleu-indigo)
  display:
    '<rect x="6" y="10" width="52" height="34" rx="5" fill="#1e1b4b"/>' +
    '<rect x="10" y="14" width="44" height="26" rx="3" fill="#3730a3"/>' +
    '<rect x="15" y="19" width="34" height="3" rx="1.5" fill="#a5b4fc"/>' +
    '<rect x="15" y="26" width="22" height="3" rx="1.5" fill="#a5b4fc" opacity=".5"/>' +
    '<rect x="15" y="33" width="14" height="3" rx="1.5" fill="#a5b4fc" opacity=".28"/>' +
    '<circle cx="45" cy="20.5" r="3.5" fill="#60a5fa"/>' +
    '<rect x="29" y="44" width="6" height="5" rx="1" fill="#1e1b4b"/>' +
    '<rect x="22" y="49" width="20" height="3.5" rx="1.7" fill="#1e1b4b"/>',

  // ── QCM : 4 cases (référence de la palette)
  category:
    '<rect x="7" y="9" width="22" height="20" rx="5" fill="#3730a3"/>' +
    '<rect x="35" y="9" width="22" height="20" rx="5" fill="#7c3aed"/>' +
    '<rect x="7" y="35" width="22" height="20" rx="5" fill="#3730a3"/>' +
    '<rect x="35" y="35" width="22" height="20" rx="5" fill="#3730a3"/>' +
    '<path d="M40 20l4 4 8-8" stroke="#fff" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>' +
    '<rect x="12" y="17" width="12" height="2.5" rx="1.2" fill="#a5b4fc" opacity=".7"/>' +
    '<rect x="12" y="43" width="12" height="2.5" rx="1.2" fill="#a5b4fc" opacity=".7"/>' +
    '<rect x="40" y="43" width="12" height="2.5" rx="1.2" fill="#a5b4fc" opacity=".7"/>',

  // ── Vrai / Faux : panneau bicolore (vert/rouge fonctionnel conservé)
  correct:
  ...
  // ── Rapidité : éclair violet-bleu
  rapidite:
    '<path d="M37 6 15 36h13l-5 22 27-33H37l2-19Z" fill="#7c3aed"/>' +
    '<path d="M37 6 15 36h13l-5 22 27-33H37l2-19Z" fill="#a5b4fc" opacity=".3"/>' +
    '<path d="M11 19H5M9 29H2M55 42h7" stroke="rgba(255,255,255,.45)" stroke-width="2" stroke-linecap="round"/>',

  // ── Vote : bulles de dialogue indigo/violet
  vote:
    '<rect x="5" y="5" width="38" height="27" rx="7" fill="#3730a3"/>' +
    '<path d="M5 26l-6 10 14-4" fill="#3730a3"/>' +
    '<rect x="11" y="12" width="12" height="2.5" rx="1.2" fill="#a5b4fc"/>' +
    '<rect x="11" y="19" width="22" height="2.5" rx="1.2" fill="#a5b4fc" opacity=".55"/>' +
    '<rect x="21" y="32" width="38" height="25" rx="7" fill="#7c3aed"/>' +
    '<path d="M59 50l6 9-14-4" fill="#7c3aed"/>' +
  ...
  // ── Défi Memory : liste ordonnée indigo/violet
  burger:
    '<rect x="4" y="6" width="56" height="15" rx="5" fill="#1e1b4b"/>' +
    '<rect x="4" y="25" width="56" height="15" rx="5" fill="#312e81"/>' +
    '<rect x="4" y="44" width="56" height="15" rx="5" fill="#3730a3"/>' +
    '<circle cx="15" cy="13.5" r="6.5" fill="#7c3aed"/>' +
    '<circle cx="15" cy="32.5" r="6.5" fill="#6d28d9"/>' +
    '<circle cx="15" cy="51.5" r="6.5" fill="#5b21b6"/>' +
    ...
    '<rect x="26" y="11" width="22" height="3" rx="1.5" fill="#a5b4fc"/>' +
    '<rect x="26" y="30" width="18" height="3" rx="1.5" fill="#a5b4fc" opacity=".65"/>' +
    '<rect x="26" y="49" width="14" height="3" rx="1.5" fill="#a5b4fc" opacity=".45"/>',

  // ── Challenge Vidéo : clap cinéma violet/indigo
  karaoke:
    '<rect x="6" y="7" width="52" height="14" rx="4" fill="#1e1b4b"/>' +
    '<path d="M16 7l-5 14h7l5-14h-7zM29 7l-5 14h7l5-14h-7zM42 7l-5 14h7l5-14h-7z" fill="#7c3aed"/>' +
    '<rect x="4" y="20" width="56" height="3" rx="1.5" fill="#0f0e2a"/>' +
    '<rect x="6" y="22" width="52" height="36" rx="5" fill="#3730a3"/>' +
    '<rect x="10" y="26" width="44" height="28" rx="3" fill="#1e1b4b"/>' +
    '<rect x="14" y="31" width="30" height="2.5" rx="1.2" fill="#a5b4fc"/>' +
    '<rect x="14" y="38" width="22" height="2.5" rx="1.2" fill="#a5b4fc" opacity=".6"/>' +
    '<rect x="14" y="45" width="16" height="2.5" rx="1.2" fill="#a5b4fc" opacity=".35"/>',

  // ── Buzzer : bouton d'alarme indigo/violet
  buzzer:
    '<circle cx="32" cy="36" r="23" fill="#1e1b4b"/>' +
    '<circle cx="32" cy="36" r="18" fill="#3730a3"/>' +
    '<circle cx="32" cy="34" r="13" fill="#7c3aed"/>' +
    '<ellipse cx="32" cy="29" rx="7.5" ry="4" fill="#a5b4fc" opacity=".45"/>' +
    '<path d="M32 8v5" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/>' +
    '<path d="M15 17l3.5 3.5M49 17l-3.5 3.5" stroke="#60a5fa" stroke-width="2" stroke-linecap="round"/>' +
    '<path d="M7 34h4M53 34h4" stroke="#60a5fa" stroke-width="2" stroke-linecap="round"/>',

  // ── Scores : coupe (or conservé — couleur universelle)
  scores:
    '<path d="M20 8h24v21c0 9-5.5 14-12 15-6.5-1-12-6-12-15V8Z" fill="#3730a3"/>' +
    '<path d="M22 10h20v19c0 8-4.5 12-10 13-5.5-1-10-5-10-13V10Z" fill="#7c3aed"/>' +
    '<path d="M9 12h11v11c0 3-5 4-6 1.5L9 12Z" fill="#312e81"/>' +
    '<path d="M55 12H44v11c0 3 5 4 6 1.5L55 12Z" fill="#312e81"/>' +
    '<rect x="30" y="43" width="4" height="8" rx="2" fill="#1e1b4b"/>' +
    '<rect x="22" y="51" width="20" height="5" rx="2.5" fill="#312e81"/>' +
    '<path d="M32 18l2 5 5.5.8-4 3.8.9 5.2-4.4-2.4-4.4 2.4.9-5.2-4-3.8 5.5-.8Z" fill="#fff"/>',
